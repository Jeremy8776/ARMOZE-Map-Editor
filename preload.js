...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    getMapCatalog: () => ipcRenderer.invoke('get-map-catalog'),
    listInstalledCatalogMaps: () => ipcRenderer.invoke('list-installed-catalog-maps'),
    downloadCatalogMap: (entry) => ipcRenderer.invoke('download-catalog-map', entry),
    deleteCatalogMap: (fileName) => ipcRenderer.invoke('delete-catalog-map', fileName),
    onCatalogDownloadProgress: (callback) => ipcRenderer.on('catalog-download-progress', (event, data) => callback(data)),
    openUserMapsFolder: () => ipcRenderer.invoke('open-user-maps-folder'),
